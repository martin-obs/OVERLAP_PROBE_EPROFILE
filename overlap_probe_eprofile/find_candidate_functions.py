...
def check_fits ( rcs_0 , rng , max_available_fit_range , config , ov ) :
...
def do_quality_checks_meteoswiss ( rcs_0 , rng , internal_temperature , max_available_fit_range , config , ov ) :
